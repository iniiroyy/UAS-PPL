<x-admin-layout>
    <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <h2 class="text-2xl font-bold text-gray-900">Tambah Pupuk Baru</h2>
        </div>
                ...
                <form action="{{ route('admin.fertilizers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="usage_instruction" id="usage_instruction" rows="3"
                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                            required>{{ old('usage_instruction') }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="url" name="purchase_link" id="purchase_link"
                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                            value="{{ old('purchase_link') }}" placeholder="https://example.com">
                        @error('purchase_link')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
